...
test_accu =  [81.5041, 86.9926, 87.0168, 87.7393, 90.3245]
...
fig, ax = plt.subplots()
rects1 = ax.bar(ind, train_accu, width, yerr=train_std,
                color='b', error_kw=dict(ecolor='g'),
                hatch='/', label='Train')
rects2 = ax.bar(ind + width, test_accu, width, yerr=test_std,
