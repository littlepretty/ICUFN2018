...
Among the various deep learning models we investigate in this paper, there are two types of generative models, i.e., Restricted Boltzmann Machine and Autoencoders. %(See Section~\ref{Sec:Architectures}). 
